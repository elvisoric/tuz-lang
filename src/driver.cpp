...
bool Driver::compile(const CompileOptions& options) {
    ...
    // Lexing
    if (options.verbose) std::cout << "  Lexing..." << std::endl;
    Lexer lexer(source);
    ...
    // Parsing
    if (options.verbose) std::cout << "  Parsing..." << std::endl;
    ...
    // Code generation
    if (options.verbose) std::cout << "  Generating LLVM IR..." << std::endl;
    ...
    if (options.emit_llvm) {
        ...
        if (options.verbose) std::cout << "  Writing LLVM IR to: " << ll_file << std::endl;
    ...
    if (options.verbose) std::cout << "  Generating object file: " << obj_file << std::endl;
...
bool Driver::link_object(const std::string& obj_file, const CompileOptions& options) {
    if (options.verbose) std::cout << "  Linking..." << std::endl;
    ...
    if (options.verbose) std::cout << "  Command: " << cmd << std::endl;
