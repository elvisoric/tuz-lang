...
Token Lexer::next_token() {
    ...
    switch (current_) {
        case '+': advance(); return Token(TokenType::PLUS, "+", start_line, start_col);
        case '*': advance(); return Token(TokenType::STAR, "*", start_line, start_col);
        case '/': advance(); return Token(TokenType::SLASH, "/", start_line, start_col);
        case '%': advance(); return Token(TokenType::PERCENT, "%", start_line, start_col);
        case '(': advance(); return Token(TokenType::LPAREN, "(", start_line, start_col);
        case ')': advance(); return Token(TokenType::RPAREN, ")", start_line, start_col);
        ...
        case '.': advance(); return Token(TokenType::DOT, ".", start_line, start_col);
    }
